        ...
        <template #dialog-text>
          <div class="pa-4 text-justify">
            ...
            <ul class="pl-4 mb-3">
              ...
              <li>
                Mindestens eine Partei / Gruppierung / Einzelmitglied vorhanden
                ist.
              </li>
            </ul>
            ...
            <p class="mb-3">
              ...
              beschränkt, die Größe des Hauptorgans sowie die Ausschussgröße auf
              {{ numberFormatter(LimitConfiguration.limitCommitteeSize) }}
              Sitze und die Stimmen auf
              {{ numberFormatter(LimitConfiguration.limitVotes) }} Stimmen. Ist
              eine Größe für das Hauptorgan angegeben, sind Sitze einzugeben.
              Andernfalls wird von Stimmen als Eingabe ausgegangen.
            </p>

            <p class="mb-3">
              Bei dem Namen der Parteien / Gruppierungen / Einzelmitglieder gilt
              ebenfalls ein Limit von
              {{ numberFormatter(LimitConfiguration.limitName) }} Zeichen.
            ...
            <p class="mb-3">
              Bevor die Vorlage angelegt werden kann, muss die Gesamtanzahl der
              Sitze aller Parteien / Gruppierungen / Einzelmitglieder mit der
              Größe des Hauptorgans übereinstimmen.
            </p>
            <p class="mb-3">
            ...
            <p class="mb-3">
              Fraktionsgemeinschaften und Ausschussgemeinschaften werden separat
              unterhalb Parteien / Gruppierungen / Einzelmitglieder angezeigt.
              Sofern mindestens zwei Einträge ausgewählt wurden, lässt sich eine
              Fraktionsgemeinschaft oder eine Ausschussgemeinschaft bilden.
            </p>
            ...
            <p>
              ...
              Fraktionsgemeinschaft-/Ausschussgemeinschaftstabelle hinzugefügte
              Parteien / Gruppierungen / Einzelmitglieder wieder zu entfernen.
              Diese lassen sich allerdings nicht wieder hinzufügen, es sei denn,
              es wird eine neue Fraktionsgemeinschaft oder eine neue
              Ausschussgemeinschaft angelegt.
            </p>
          </div>
        </template>
      </info-dialog>
    ...
    <v-row>
      <v-col class="d-flex align-center">
        ...
        <v-btn
          ...
          :disabled="
            !isValid || (selectedBaseData && !dirty) || basedataNameIsNotChanged
          "
