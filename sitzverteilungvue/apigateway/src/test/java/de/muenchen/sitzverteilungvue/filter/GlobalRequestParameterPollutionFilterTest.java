 ...
 */
package de.muenchen.sitzverteilungvue.filter;
...
class GlobalRequestParameterPollutionFilterTest {
    ...
    void parameterPollutionAttack() {
        ...
        String url = "/api/sitzverteilung-backend-service/testendpoint?parameter1=testdata_1&parameter2=testdata&parameter1=testdata_2";
