 ...
 */
package de.muenchen.sitzverteilung.rest;
...
@PreAuthorize("hasAuthority(T(de.muenchen.sitzverteilung.security.AuthoritiesEnum).SITZVERTEILUNG_READ_THEENTITY.name())")
public interface TheEntityRepository extends CrudRepository<TheEntity, UUID> { //NOSONAR
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.sitzverteilung.security.AuthoritiesEnum).SITZVERTEILUNG_WRITE_THEENTITY.name())")
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.sitzverteilung.security.AuthoritiesEnum).SITZVERTEILUNG_DELETE_THEENTITY.name())")
